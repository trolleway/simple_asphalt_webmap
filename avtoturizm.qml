...
<qgis version="2.18.28-Las Palmas" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="smoothness">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="mtb_scale">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{98d889f4-9137-4852-bfb1-fead4ccd30bc}">
      <rule filter="&quot;surface&quot; = 'asphalt' AND &quot;highway&quot; NOT IN ('footway','path','pedestrian','service')" key="{2c61c3b3-5b1f-4fdf-8020-b4eed0b3c5c5}" symbol="0" label="asphalt"/>
    </rules>
    <symbols>
  ...
  <aliases>
    ...
    <alias field="smoothness" index="5" name=""/>
    <alias field="mtb_scale" index="6" name=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="mtb_scale"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="smoothness" expression=""/>
    <default field="mtb_scale" expression=""/>
